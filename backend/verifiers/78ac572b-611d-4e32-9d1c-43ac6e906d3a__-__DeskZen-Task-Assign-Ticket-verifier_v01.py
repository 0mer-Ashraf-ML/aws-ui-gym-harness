...
def on_start(prompt: str, base_url: str) -> Dict[str, Any]:
    ...
    assignee_id = target_assignee.get("id") if target_assignee else None
...
def on_end(prompt: str, base_url: str, verifier_on_start_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    expected_assignee_id = verifier_on_start_data.get("expected_assignee_id")
    ...
    current_assignee_id = assignee_user.get("id")
